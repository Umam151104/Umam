        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="product-slider">
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="assets/images/dior.jpeg" />
                  </li>
                  <li>
                    <img src="assets/images/dior1.jfif" />
                  </li>
                  <li>
                    <img src="assets/images/dior2.jfif" />
                  </li>
                  <li>
                    <img src="assets/images/dior3.jfif" />
                  </li>
          ...
          <div class="col-md-6">
            <div class="right-content">
              ...
              <p>BARANG HIGH QUALITY
                TERSEDIA UKURAN M/L/XL/XXL/XXXL(PESAN UKURAN DICHAT YA BIAR KAMI KIRIM SESUAI YG ANDA INGINKAN)
                BAHAN PRASUT BARANG BUKAN ABAL2 GAN .
                #HAPPY SHOPPING </p>
              <span>45 stok</span>
              ...
              <div class="down-content">
                <div class="categories">
                  <h6>Category: <span><a>Jaket</a>,<a>Women</a>,<a>Mens</a>,</span></h6>
                </div>
                <div class="share">
                  <h6>Share: <span>
   ...
   <div class="footer">
    ...
    <script>
        function redirectToWhatsApp() {
            ...
            var message = "Saya ingin memesan " + quantity + " JAKET DIOR.";
