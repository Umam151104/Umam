                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="product" class="form-control" id="product">
                            ...
                            <option value="NIKE AF1">NIKE AF1</option>
                            <option value="JAKET DIOR">JAKET DIOR</option>
                            <option value="JEANS DENIM">JEANS DENIM</option>
                            <option value="JAKET HOODIE GAP">JAKET HOODIE GAPS</option>
                            <option value="CHINO UNIQLO">CHINO UNIQLO</option>
                            <option value="T-SHIRT ERIGO"> T-SHIRT ERIGO</option>
                            <option value="T-SHIRT AEROSTREET">T-SHIRT AEROSTREET</option>
                            <option value="CONVERSE HIGH ORI">CONVERSE HIGH ORI</option>
                            <option value="SWEATER AEROSTREET">SWEATER AEROSTREET</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Catatan</label>
