        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="product-slider">
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="assets/images/converse.jpeg" />
                  </li>
                  <li>
                    <img src="assets/images/converse1.jfif" />
                  </li>
                  <li>
                    <img src="assets/images/converse2.jfif" />
                  </li>
                  <li>
                    <img src="assets/images/converse3.jpg" />
                  </li>
          ...
          <div class="col-md-6">
            <div class="right-content">
              ...
              <p>Silahkan dipilih sesuai selera kalian... Barang di jamin 100% Original yaa!!!</p>
              <span> 35 stok</span>
              ...
              <div class="down-content">
                <div class="categories">
                  <h6>Category: <span><a>Sneakers</a>,<a>Men's</a>,<a>Women</a>,<a>Lifestyle</a></span></h6>
                </div>
                <div class="share">
                  <h6>Share: <span>
                  ...
                  <a href="http://wa.me/62895603558398"><i class="fa fa-whatsapp"></i></a></span>
                </h6>
                </div>
              </div>
            </div>
   ...
   <div class="subscribe-form">
    ...
    <script>
        function redirectToWhatsApp() {
            ...
            var message = "Saya ingin memesan " + quantity + " CONVERSE HIGH ORI.";
