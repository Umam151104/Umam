...
<head>
    ...
    <!-- Tooplate 2114 Pixie https://www.tooplate.com/view/2114-pixie -->
</head>
                    ...
                    <div class="product-slider">
                        <div id="slider" class="flexslider">
                            <ul class="slides">
                                ...
                                <li>
                                    <img src="assets/images/aero1.webp" />
                                </li>
                                <li>
                                    <img src="assets/images/aero2.webp" />
                                </li>
                                <li>
                                    <img src="assets/images/aero3.webp" />
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="right-content">
                        ...
                        <div class="down-content">
                            <div class="categories">
                                <h6>Category: <span><a>T-shirt</a>,<a>Women</a>,<a>Mens</a>,</span></h6>
                            </div>
                            <div class="share">
                                <h6>Share: <span><a href="https://www.facebook.com/muhammad.haidilumam.1">
                                            <i class="fa fa-facebook"></i></a><a
                                        href="https://www.instagram.com/mh.umam1511/"><i
                                            class="fa fa-instagram"></i></a><a href="http://wa.me/62895603558398"><i
                                            class="fa fa-whatsapp"></i></a></span></h6>
                            </div>
                        </div>
                    </div>
                </div>
   ...
   <div class="subscribe-form">
    ...
    <script>
        function redirectToWhatsApp() {
            ...
            var message = "Saya ingin memesan " + quantity + " T-SHIRT AEROSTREET.";
