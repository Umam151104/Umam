  ...
  <body>
          ...
          <div class="col-md-6">
            <div class="product-slider">
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="assets/images/sweater.webp" />
                  </li>
                  <li>
                    <img src="assets/images/sweater1.webp" />
                  </li>
                  <li>
                    <img src="assets/images/sweater2.webp" />
                  </li>
                  <li>
                    <img src="assets/images/sweater3.webp" />
                  </li>
          ...
          <div class="col-md-6">
            <div class="right-content">
              ...
              <p>Bahan :
                ...
                - Fleece - Extra Soft Finishing
                
                - Jaminan sablon plastisol awet dan tahan lama
                
                - Sejuk dan nyaman saat dipakai</p>
              <span> 35 stok</span>
              ...
              <div class="down-content">
                <div class="categories">
                  <h6>Category: <span><a>Sweater</a>,<a>Men's</a>,<a>Lifestyle</a></span></h6>
                </div>
                <div class="share">
                  <h6>Share: <span>
    ...
    <script>
        function redirectToWhatsApp() {
            ...
            var message = "Saya ingin memesan " + quantity + " SWEATER AEROSTREET.";
