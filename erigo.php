  ...
  <body>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="product-slider">
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="assets/images/erigo.jpeg" />
                  </li>
                  <li>
                    <img src="assets/images/erigo1.jfif" />
                  </li>
                  <li>
                    <img src="assets/images/erigo2.jfif" />
                  </li>
                  <li>
                    <img src="assets/images/erigo3.jpg" />
                  </li>
          ...
          <div class="col-md-6">
            <div class="right-content">
              <h4>T-SHIRT ERIGO</h4>
              <h6>Rp.250.000,00</h6>
              <p>"T-Shirt Erigo saat ini merupakan salah satu lini pakaian terbaik dan berkualitas tinggi di antara Local Brand Indonesia. Dibuat dengan bahan cotton yang nyaman untuk menemani harimu dan memiliki print desain yang unik. .</p>
              <span> 40 stok</span>
              ...
              <div class="down-content">
                <div class="categories">
                  <h6>Category: <span><a>T-shirt</a>,<a>Men's</a>,<a>Women</a><a>Lifestyle</a></span></h6>
                </div>
                <div class="share">
                  <h6>Share: <span>
    ...
    <script>
        function redirectToWhatsApp() {
            ...
            var message = "Saya ingin memesan " + quantity + " T-SHIRT ERIGO.";
