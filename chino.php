...
<body>
        ...
        <div class="container">
            ...
            <div class="product-slider">
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="assets/images/uniqlo.webp" />
                  </li>
                  <li>
                    <img src="assets/images/uniqlo1.webp" />
                  </li>
                  <li>
                    <img src="assets/images/uniqlo2.jpeg" />
                  </li>
                  <li>
                    <img src="assets/images/uniqlo3.webp" />
                  </li>
              ...
              <div id="carousel" class="flexslider">
                ...
                <div class="col-md-6">
                    <div class="right-content">
                        <h4>CHINO UNIQLO</h4>
                        <h6>Rp.250.000,00</h6>
                        <p>Celana chino klasik untuk pria yang nyaman dikenakan. Dengan siluet straight stylish.</p>
                        <span> 35 stok</span>
                        ...
                        <div class="down-content">
                            <div class="categories">
                                <h6>Category: <span><a>Pants</a>,<a>Men's</a>,<a>Lifestyle</a></span></h6>
                            </div>
                            <div class="share">
                                <h6>Share: <span><a href="https://www.facebook.com/muhammad.haidilumam.1">
                                  <i class="fa fa-facebook"></i></a>
                                  <a href="https://www.instagram.com/mh.umam1511/">
                                  <i class="fa fa-instagram"></i></a>
                                  <a href="http://wa.me/62895603558398">
    ...
    <script>
        function redirectToWhatsApp() {
            ...
            // Replace this with your WhatsApp number and message
            var whatsappNumber = "62895603558398"; // Replace with your WhatsApp number
            var message = "Saya ingin memesan " + quantity + " Chino Uniqlo.";
