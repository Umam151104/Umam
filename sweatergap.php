  ...
  <body>
          ...
          <div class="col-md-6">
            <div class="product-slider">
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="assets/images/gap.webp" />
                  </li>
                  <li>
                    <img src="assets/images/gap1.webp" />
                  </li>
                  <li>
                    <img src="assets/images/gap4.webp" />
                  </li>
                  <li>
                    <img src="assets/images/gap3.jpg" />
                  </li>
            ...
            <div class="right-content">
              ...
              <div class="down-content">
                <div class="categories">
                  <h6>Category: <span><a>Sweater</a>,<a>Men's</a>,<a>Women</a>,<a>Lifestyle</a></span></h6>
                </div>
                <div class="share">
                  <h6>Share: <span>
          ...
          <div class="col-md-12">
            <div class="footer-menu">
              <ul>
                ...
                <li><a href="contact.phpl">Kontak</a></li>
    ...
    <script>
        function redirectToWhatsApp() {
            ...
            var message = "Saya ingin memesan " + quantity + " JAKET HOODIE GAP.";
