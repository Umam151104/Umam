  ...
  <body>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="product-slider">
              <div id="slider" class="flexslider">
                <ul class="slides">
                  <li>
                    <img src="assets/images/nike.jpeg" />
                  </li>
                  <li>
                    <img src="assets/images/nike1.jfif" />
                  </li>
                  <li>
                    <img src="assets/images/nike2.jpg" />
                  </li>
                  <li>
                    <img src="assets/images/nike3.jfif" />
                  </li>
          ...
          <div class="col-md-6">
            <div class="right-content">
              ...
              <p>Nike Air Force 1 bisa jadi pilihan untuk kamu yang mencari sepatu stylish dan nyaman dipakai. Seri sepatu Nike yang satu ini memang cukup banyak diminati karena modelnya yang tidak lekang oleh waktu dan desainnya yang nyaman. Tentunya, kamu bisa beli Nike Air Force 1 dengan mudah di Pixie shop. Di sini sudah tersedia koleksi sepatunya yang terlengkap untuk pria maupun wanita. Kamu juga bisa menemukan penawaran harga sepatu Nike Air Force 1 yang termurah dengan cepat</p>
              <span>45 stok</span>
              ...
              <div class="down-content">
                <div class="categories">
                  <h6>Category: <span><a>Sneakers</a>,<a>Women</a>,<a>Mens</a>,</span></h6>
                </div>
                <div class="share">
                  <h6>Share: <span>
    ...
    <script>
        function redirectToWhatsApp() {
            ...
            var message = "Saya ingin memesan " + quantity + " NIKE AF1.";
